...
int main(int, char*[])
{
	...
	{
		Eigen::Vector3d pos(MathTools::rand_float(3,-3), MathTools::rand_float(3,-3), MathTools::rand_float(3,-3));
		...
		ptrE->set_axis_lengths(Eigen::Array3d(MathTools::rand_float(3,0.2), MathTools::rand_float(3,0.2), MathTools::rand_float(3,0.2)));
